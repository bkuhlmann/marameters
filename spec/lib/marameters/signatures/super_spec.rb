...
RSpec.describe Marameters::Signatures::Super do
  ...
  describe "#call" do
    ...
    it "answers name with required positionals" do
    ...
    it "answers name with optional positionals" do
    ...
    it "answers ancestor positionals when descendant has no matching parameters" do
    ...
    it "answers anonymous single splat when ancestor has no matching positionals" do
      ancestor = Marameters::Probe.new [%i[req one]]
    ...
    it "answers name with duplicate required keyword" do
    ...
    it "answers name with duplicate optional keyword" do
    ...
    it "answers anonymous double splat with required keywords" do
      ancestor = Marameters::Probe.new [%i[keyreq one]]
    ...
    it "answers anonymous double splat with optional keywords" do
      ancestor = Marameters::Probe.new [%i[key one]]
