...
* 🟢 Added any source reader - Brooke Kuhlmann
* 🟢 Added deprecation warnings to sources objects - Brooke Kuhlmann
* 🟢 Added disk source reader - Brooke Kuhlmann
* 🟢 Added function sourcer - Brooke Kuhlmann
* 🟢 Added memory source reader - Brooke Kuhlmann
* 🔼 Updated signature defaulter to use function sourcer - Brooke Kuhlmann
